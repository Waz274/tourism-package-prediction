...
param_grid = {
    ...
    'xgbclassifier__colsample_bytree': [0.8],    # Fraction of features sampled when building each tree.
    'xgbclassifier__colsample_bylevel': [1.0],   # Fraction of features sampled at each tree level.
